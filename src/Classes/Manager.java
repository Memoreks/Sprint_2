...
public class Manager {
    ...
    public String out_tasks(HashMap<Integer, Task> tasks){
    ...
    public String out_subtasks(HashMap<Integer, Subtask> subtasks) {
    ...
    public String out_epics(HashMap<Integer, Epic> epics) {
